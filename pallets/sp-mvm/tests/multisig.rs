...
use common::mock::*;
use common::addr::{alice_public_key, bob_public_key, root_ps_acc};
use common::assets::{UserMod, UserTx, BinAsset};
use common::utils::publish_module;
...
fn execute_multisig() {
    new_test_ext().execute_with(|| {
        ...
        frame_support::assert_ok!(Multisig::as_multi(
